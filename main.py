...
def generate_recommendation(mood):
    ...
    outputs = model.generate(
        **inputs,
        max_length=70, # Длина ответа ИИ
        do_sample=True, # Случайность ответа
        top_p=0.7, # Вероятность выбора, если больше .9 то больше разнообразия
        temperature=0.5, # Творчество модели
